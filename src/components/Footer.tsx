...
import { Mail, Instagram, Facebook, Phone, MessageCircle } from "lucide-react";
      ...
      <div className="container mx-auto px-4 md:px-8 flex flex-col md:flex-row justify-between items-start">
        ...
        <div>
          ...
          <div className="flex gap-4">
            ...
            <Link to="https://wa.me/27817098779" target="_blank" className="bg-green-500 p-2 rounded-md hover:scale-110 transition-transform">
