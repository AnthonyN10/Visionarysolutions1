      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-col md:flex-row gap-6 mb-8">
          {cardData.map((card, idx) => (
            ...
            >
              <Card className={`h-full shadow-lg border-none hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 animate-slide-in-right`}>
                <CardContent className="p-6">
                  <h2 className="text-2xl font-bold text-[#0a1657] mb-4 text-center">{card.title}</h2>
                  {card.content}
                </CardContent>
              </Card>
            </div>
